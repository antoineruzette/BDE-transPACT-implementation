...
def run_pplacer(reference_alignment, alignment_file, data_dir):
    """Function that uses the reference tree with the new alignment to place
    query domains onto reference tree.
    """
    #Locations of files
    reference_tree = os.path.join(data_dir, "dendrogram20190514/RAxML_bestTree.649KS_sequences_hmmalign_raxml_renamed.tre")
    ...
    pplacer_cmd = ["pplacer", "-t", reference_tree, "-r", reference_alignment, "-o", pplacer_json, "-c", os.path.join(data_dir, "dendrogram20190514/RAxML_bestTree.649KS_sequences_hmmalign_raxml_renamed.refpkg"), alignment_file]
