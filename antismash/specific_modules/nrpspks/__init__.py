...
from .html_output import will_handle, generate_sidepanel, generate_details_div, generate_domain_alignment_div
...
_markov_models = [
    ...
    'ksdomains.hmm',
    'nrpspksdomains.hmm',
    path.join('sandpuma', 'flat', 'fullset0_smiles', 'fullset0_smiles_nrpsA.hmmdb')
]
...
def _predicat_id_lines():
    """Load prediCAT domain ID lines once on module load"""
    from nrps_utils import load_id_lines
    return load_id_lines()


predicat_id_lines = _predicat_id_lines()


__all__ = [ check_prereqs, specific_analysis, will_handle, generate_sidepanel,
            generate_details_div, generate_domain_alignment_div ]
